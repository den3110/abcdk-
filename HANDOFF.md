...
> 10b. **Icon app mới (13/09)** — logo PickleTour badge tròn; `assets/images/icon-v3.png` + `adaptive-icon-v3.png`, app.json icon/adaptiveIcon, 5 appiconset iOS, mipmap Android (foreground 108dp chuẩn). Mobile commit tiếp sau `38416e0`. **Cần build native mới lên store; OTA không đổi icon.** Chi tiết root `../HANDOFF.md`.
