export default {
  ...
  tournaments: {
    ...
    bracket: {
      ...
      v3Overview: "Overview",
      v3Matches: "Matches",
      v3Standings: "Standings",
      v3Bracket: "Bracket",
      v3More: "More",
      v3BackToCurrent: "Open current bracket",
      v3FullSchedule: "Full schedule",
      v3Today: "Today",
      v3Final: "FT",
      v3Live: "LIVE",
      v3Ready: "Ready",
      v3Planned: "Not started",
      v3PointsShort: "Pts",
      v3NewsSource: "PickleTour",
      v3NewsTitle: "Schedule, results and standings for {name}",
      v3NewsBody: "Updated from the tournament data currently available.",
    ...
    manage: {
      ...
      exportRegistrationTeamsPdf: "Registered teams (PDF)",
      exportRegistrationTeamsWord: "Registered teams (Word)",
      exportRegistrationTeamsLoading: "Exporting registered teams…",
      ...
      registrationExportTeamsPdfFailed: "Failed to export registered teams",
      registrationExportTeamsWordFailed: "Failed to export registered teams (Word)",
      ...
      registrationExportSubtitle:
        "Event: {type} • {count} athletes • Exported at: {time}",
      registrationExportTeamsTitle: "Registered teams",
      registrationExportTeamsSubtitle:
        "Event: {type} • {count} teams • Exported at: {time}",
    ...
    registration: {
      ...
      form: {
        ...
        switchSelfPosition: "Switch your position",
        scorePrefix: "Score:",
      ...
      list: {
        ...
        joinAsPartner: "Request to pair",
        joining: "Sending...",
        joinConfirm: "Send a pairing request to this player?",
        joinSuccess: "Request sent — waiting for Player 1 to approve.",
        joinError: "Action failed. Please try again.",
        requestSent: "Request sent — pending",
        applicants: "Pairing requests",
        approve: "Approve",
        reject: "Reject",
        approveConfirm: "Choose {name} as your partner?",
        approveSuccess: "Paired up successfully!",
  ...
  rankings: {
    ...
    gradeHistory: {
      openTooltip: "View rating history",
      title: "Rating history – {name}",
      subtitle: "{count} latest entries",
