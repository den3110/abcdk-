...
export default function SiteFooter() {
  ...
  const cols = [
    [t("v3.siteFooter.colProduct"), [[t("v3.siteFooter.tournaments"), "/pickle-ball/tournaments"], [t("v3.siteFooter.rankings"), "/pickle-ball/rankings"], [t("v3.siteFooter.live"), "/live"], [t("v3.siteFooter.clubs"), "/clubs"]]],
    [
      t("v3.siteFooter.colAccount"),
      authed
        ? [[t("v3.siteFooter.profile"), "/profile"], [t("v3.siteFooter.myTournaments"), "/my-tournaments"], [t("v3.siteFooter.bookings"), "/my-bookings"]]
        : [[t("v3.siteFooter.login"), "/login"], [t("v3.siteFooter.register"), "/register"], [t("v3.siteFooter.profile"), "/profile"]],
    ],
    [t("v3.siteFooter.colSupport"), [[t("v3.siteFooter.contact"), "/contact"], [t("v3.siteFooter.status"), "/status"], [t("v3.siteFooter.news"), "/blog"]]],
    [t("v3.siteFooter.colLegal"), [[t("v3.siteFooter.privacy"), "/privacy-and-policy"], [t("v3.siteFooter.terms"), "/terms"], [t("v3.siteFooter.cookies"), "/cookies"]]],
  ];
  return (
        ...
        <div style={{ padding: "64px 0 40px" }}>
          <div className="pk-foot" style={{ display: "grid", gridTemplateColumns: "1.6fr repeat(4, 1fr)", gap: 40 }}>
            <div style={{ maxWidth: 280 }}>
              ...
              <div style={{ marginTop: 16 }}><Text type="supporting" color="secondary">{t("v3.siteFooter.tagline")}</Text></div>
            </div>
            {cols.map(([h, links]) => (
          ...
          <div style={{ marginTop: 44, display: "flex", flexDirection: "column", gap: 12 }}>
            <Text type="supporting" weight="semibold">{t("v3.siteFooter.communityHeading")}</Text>
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
              ...
              >
                ...
                {t("v3.siteFooter.facebookFanpage")}
              </a>
              <a
                href={ZALO_GROUP_URL}
                target="_blank"
          ...
          <div style={{ borderTop: "1px solid var(--color-border)", paddingTop: 24, display: "flex", justifyContent: "space-between", gap: 16, flexWrap: "wrap" }}>
            ...
            <Text type="supporting" color="tertiary">{t("v3.siteFooter.builtWith")}</Text>
          </div>
        </div>
      </Container>
    </div>
