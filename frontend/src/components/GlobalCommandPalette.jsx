  ...
  const pageItems = useMemo(() => {
    const items = [
      ...
      createPaletteItem({
        ...
        subtitle: "/live",
        description: "Feed live toàn màn hình theo từng trận.",
        path: "/live",
        iconKey: "status",
        color: "#dc2626",
        priority: 126,
        keywords: ["live", "feed", "stream", "trực tiếp", "xem live"],
        aliases: ["live feed", "watch live"],
      }),
      createPaletteItem({
        id: "page:live-clusters",
        scope: "pages",
        title: "Live theo cụm sân",
        subtitle: "/live/clusters",
        description: "Xem live theo cụm sân và sân vật lý.",
        path: "/live/clusters",
        iconKey: "stadium",
        color: "#0f766e",
        priority: 124,
        keywords: ["live", "cụm sân", "cluster", "court", "sân"],
        aliases: ["court clusters", "xem theo sân"],
      }),
      createPaletteItem({
        id: "page:contact",
        scope: "pages",
