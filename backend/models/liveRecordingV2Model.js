...
const liveRecordingV2SegmentSchema = new mongoose.Schema(
  {
    ...
    aiCommentary: {
      ...
      latestJobId: { type: mongoose.Schema.Types.ObjectId, default: null },
      sourceDriveFileId: { type: String, default: null },
      language: { type: String, default: null },
      voicePreset: { type: String, default: null },
      tonePreset: { type: String, default: null },
