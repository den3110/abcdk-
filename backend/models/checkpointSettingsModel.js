...
const checkpointSettingsSchema = new mongoose.Schema(
  {
    ...
    trustDays: { type: Number, default: 45 },
    ...
    thresholds: {
      level1Score: { type: Number, default: 40 },
      level2Score: { type: Number, default: 75 },
      level3Score: { type: Number, default: 110 },
      minSignalsForLevel1: { type: Number, default: 3 },
      minCategoriesForLevel1: { type: Number, default: 2 },
      minCategoriesForLevel2: { type: Number, default: 2 },
      minCategoriesForLevel3: { type: Number, default: 3 },
    },
    hardSignals: {
      checkpointFailedWeek: { type: Number, default: 10 },
      abuseWeek: { type: Number, default: 3 },
      criticalMonth: { type: Number, default: 2 },
      authFailedDay: { type: Number, default: 30 },
      rateLimitedDay: { type: Number, default: 16 },
    },
    rules: {
